...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=/front/Alipay/topay method=post
			target="_blank">
		...
		<form name=tradequery action=/front/Alipay/query method=post
			target="_blank">
		...
		<form name=traderefund action=/front/Alipay/refund method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=/front/Alipay/refundquery method=post
			target="_blank">
		...
		<form name=tradeclose action=/front/Alipay/close method=post
			target="_blank">
