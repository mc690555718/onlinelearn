...
<body>
	<form class="form-horizontal" id="div1" method="post"
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" name="title" id="title"
					...
					onblur="fun(this,1)"><span id="d1"></span>
			</div>
			<span id="d1"></span>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="describes"
					name="describes" value="${img.describes }"
					placeholder="请输入描述,只能输入中文汉字" maxlength="20" onblur="fun(this,2)"><span
					id="d2"></span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="" class="form-control" id="linkAddress"
					...
					placeholder="请输入跳转链接" maxlength="20" onblur="fun(this,3)"><span
					id="d3"></span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="" class="form-control" id="seriesNumber"
					...
					placeholder="请输入排序,只能输入数字" maxlength="3"
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div>
					<img id="imageUrl" alt="" src="${img.imageUrl}" name="imageUrl"
						class="t1"><label style="color: red">(请上传图片文件)</label> <input
						type="hidden" name="hiddens" value="${img.imageUrl }"><input
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button class="btn btn-default" id="cy" onclick="update()">修改</button>
