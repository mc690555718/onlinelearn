	...
	<div class="larry-personal">
		...
		<div class="layui-inline">
		    ...
		    <label class="layui-inline tt">专业:</label>
		     <div class="layui-input-inline">
		    	<select class="layui-input"  width="150" name="subject_id"  id="subject_id">
		    	   <option value="-1" selected="selected">请选择</option>
		    ...
		    <div class="layui-input-inline">
		    	<input id="add_time" name="add_time" class="layui-input" id="date" type="text" placeholder="yyyy-MM-dd" autocomplete="off" lay-verify="date">
		    </div>
		    <label class="layui-inline tt">-</label>
		    <div class="layui-input-inline">
		        <input id="end_time" name="end_time" class="layui-input" id="date" type="text" placeholder="yyyy-MM-dd" autocomplete="off" lay-verify="date">
		    </div>
