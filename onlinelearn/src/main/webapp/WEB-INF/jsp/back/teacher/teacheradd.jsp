		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" method="post"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="name" id="name" class="layui-input"
							maxlength="5" placeholder="讲师名称不得超过5个字" onblur="fun(this,1)">
						<span id="d1"></span>
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" id="education" name="education"
							class="layui-input" maxlength="50" placeholder="讲师资历不得超过50个字"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="sort" id="sort" class="layui-input"
							onblur="fun(this,4)"> <span id="d4"></span>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea class="form-control" name="career" id="career" rows="3"
							maxlength="300" onblur="fun(this,3)" placeholder="讲师简介不得超过300个字"></textarea>
						<span id="d3"></span>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div>
							<div class="col-sm-4">
								<img id="blah" style="width: 200px; height: 150px;" /> <input
									type="hidden" runat="server" id="file" /> <input type="file"
									name="file" id="imgInp">
							</div>
						</div>
					</div>
