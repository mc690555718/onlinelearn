							...
							<section class="hLh30 txtOf mt5 pb20 mreadnum">
								<div class="fr">
									<span> <a class="noter-dy vam" title="评论" href="#i-art-comment">
										...
										</a> <tt title="赞一下" onclick="addPraise('${article.article_id}',3)" class="noter-zan vam ml5 f-fM">
											<em class="icon18">&nbsp;</em>(<span class="addPraise${article.article_id}_3 praise_count">0</span>)
										</tt>
									</span>
								</div>
							...
							<section class="mt20 tac" id="sharebutton">
								<div class="bdsharebuttonbox clearfix disIb">
									<div class="pr disIb fl of">
										<a href="javascript:void(0)" onclick="addActiclePraise('${article.article_id}',3)"  title="" class="zan-icon dz-btn pr"></a>
										<div class="dz-num">
