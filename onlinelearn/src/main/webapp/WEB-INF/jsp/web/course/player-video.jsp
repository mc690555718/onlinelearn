...
<link rel="stylesheet" type="text/css" href="/js/inxweb/css/reset.css">
<link rel="stylesheet" type="text/css" href="/js/inxweb/css/theme.css">
<link rel="stylesheet" type="text/css" href="/js/inxweb/css/global.css">
<link rel="stylesheet" type="text/css" href="/js/inxweb/css/web.css">
<script type="text/javascript" src="/js/jquery.js"></script>
<script type="text/javascript" src="/js/common/webutils.js"></script>
<script type="text/javascript" src="/js/inxweb/header/header.js"></script>
<script type="text/javascript" src="/js/inxweb/js/common.js"></script>
</head>
<body>
			...
			<div class="pr15">
				...
				<header class="p-h-header">
					<section class="p-h-head">
						...
						<h2 class="p-h-title"><span class="c-fff" id="contentTitle"></span></h2>
				...
				<!-- /学习进度条 结束-->
					...
					<div class="p-h-video of">
						...
						<section class="p-h-video-tip">
							<img src="/js/inxweb/img/v-loading.gif">
								...
								<section class="p-h-r-menu mt10">
									<div class="lh-menu-wrap">
										...
										<!-- 文件目录 -->
															...
															<c:set var="folderIndex" value=""/>
													
													<!-- 视频 -->
															<li class="lh-menu-stair">
																<ul class="lh-menu-ol no-parent-node">
																	<li class="lh-menu-second"><a title="" onclick="getPlayerHtml(this)" href="javascript:void(0)">
																			<span class="fr"> 
																				...
																				</span><em class="lh-menu-i-2 icon14 mr5">&nbsp;</em>1${parentKpoint.name }</a>
																	</li>
																</ul>
															</li>
									...
									<ol>
											...
											<li>
												<aside class="course-r-pic">
													<a href="/front/couinfo/" title="">
														<c:choose>
															<c:when test="">
																<img alt="" src="" />
															</c:when>
															<c:otherwise>
																<img alt="" src="/js/inxweb/img/default-img.gif" />
															</c:otherwise>
														</c:choose>
													</a>
												</aside>
												<section class="hLh20 txtOf">
													<a href="/front/couinfo/" class="c-333 fsize16"></a>
												</section>
	...
	<!-- 公共底引入 -->
	<script src="/js/inxweb/comment/comment.js" type="text/javascript"></script><!-- 评论js -->
	<script type="text/javascript" src="/kindeditor/kindeditor-all.js"></script>
	<script type="text/javascript" src="/js/inxweb/play/playVideo.js"></script>
