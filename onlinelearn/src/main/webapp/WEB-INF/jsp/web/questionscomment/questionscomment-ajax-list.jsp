	...
	<div class="good-anwer-box">
		...
		<section class="good-answer mt10">
			<section class="question-list lh-bj-list pr">
				<ul class="pr10">
					<c:forEach items="${comments}" var="questionsComment">
						<li>
...
<div class="q-i-noter-box">
	...
	<c:if test="${not empty questionsCommentList  }">
		<div class="q-n-r-box">
			<section class="question-list lh-bj-list pr">
				<ul class="pr10">
					<c:forEach items="${qc}" var="questionsComment" varStatus="index">
						<li>
							<aside class="noter-pic">
								<c:choose>
									<c:when test="${not empty questionsComment.edu_user.pic_img }">
							...
							<div class="of hLh20">
								<c:if test="${questionsCommentList.status==0 and  questionsCommentList.cus_id==edu_user.user_id and questionsComment.cus_id != questions.cus_id}">
