...
<body>
														...
														<c:if test="${parentKpoint.kpoint_type==1 }"><!-- 视频 -->
															<li class="lh-menu-stair">
																<ul class="lh-menu-ol no-parent-node">
																	<li class="lh-menu-second"><a title="" onclick="getPlayerHtml(${parentKpoint.kpoint_id },'${parentKpoint.name }',this)" href="javascript:void(0)">
																			<span class="fr"> 
	...
	<!-- 公共底引入 -->
	<script type="text/javascript" src="/static/common/jquery-3.2.0.min.js"></script>
