			...
			<section>
				<div>
					...
					<section class="c-infor-tabTitle c-tab-title cnew-tab-title">
						<a href="javascript: void(0)" title="Wo的问答"
							style="cursor: default;">Wo的问答</a> <a
							href="${ctx }/uc/myquestions/list" title="Wo的提问" class="current">Wo的提问</a>
				...
				<div class="mt40">
					<c:if test="${empty questions }">
						...
						<section class="no-data-wrap">
							<em class="icon30 no-data-ico">&nbsp;</em> <span
								class="c-666 fsize14 ml10 vam">亲，您还没有提过问题，快去提问吧！</span>
						</section>
						<!-- /无数据提示 结束-->
					</c:if>
									...
									<c:forEach items="${questions }" var="question">
										<li>
											...
											<section class="q-txt-box">
												<a class="replyBrowseNum" href="/front/info/${question.id }"
													title="">
													<div class="replyNum">
												...
												<div class="mt15">
													...
													<section class="fl ml20 pt10">
														<div class="taglist clearfix">
															<c:forEach items="${question.questions_tags }"
																var="questionsTag">
																<a title="${questionsTag.questions_tag_name }"
																	data-id="${questionsTag.questions_tag_id}"
																	class="list-tag" href="#">${questionsTag.questions_tag_name}</a>
															</c:forEach>
														</div>
													</section>
													<div class="clear"></div>
					...
					<!-- 公共分页 结束 -->
					<form action="${ctx}/uc/myquestions/list" id="searchForm"
						method="post">
